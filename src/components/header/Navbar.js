                            ...
                            <div className="megamenu style1">
                                <ul className="grid mmWrapper">
                                    <li className="grid__item large-up--one-whole">
                                        <ul className="grid">
                                            <li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">Home Group 1</a>
                                                <ul className="subLinks">
                                                  <li className="lvl-2"><a href="index.html" className="site-nav lvl-2">Home 1 - ClassNameic</a></li>
                                                  <li className="lvl-2"><a href="home2-default.html" className="site-nav lvl-2">Home 2 - Default</a></li>
                                                  <li className="lvl-2"><a href="home15-funiture.html" className="site-nav lvl-2">Home 15 - Furniture <span className="lbl nm_label1">New</span></a></li>
                                                  <li className="lvl-2"><a href="home3-boxed.html" className="site-nav lvl-2">Home 3 - Boxed</a></li>
                                                  <li className="lvl-2"><a href="home4-fullwidth.html" className="site-nav lvl-2">Home 4 - Fullwidth</a></li>
                                                  <li className="lvl-2"><a href="home5-cosmetic.html" className="site-nav lvl-2">Home 5 - Cosmetic</a></li>
                                                  <li className="lvl-2"><a href="home6-modern.html" className="site-nav lvl-2">Home 6 - Modern</a></li>
                                                  <li className="lvl-2"><a href="home7-shoes.html" className="site-nav lvl-2">Home 7 - Shoes</a></li>
                                                </ul>
                                              </li>
                                            <li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">Home Group 2</a>
                                                <ul className="subLinks">
                                                    <li className="lvl-2"><a href="home8-jewellery.html" className="site-nav lvl-2">Home 8 - Jewellery</a></li>
                                                    <li className="lvl-2"><a href="home9-parallax.html" className="site-nav lvl-2">Home 9 - Parallax</a></li>
                                                    <li className="lvl-2"><a href="home10-minimal.html" className="site-nav lvl-2">Home 10 - Minimal</a></li>
                                                    <li className="lvl-2"><a href="home11-grid.html" className="site-nav lvl-2">Home 11 - Grid</a></li>
                                                    <li className="lvl-2"><a href="home12-category.html" className="site-nav lvl-2">Home 12 - Category</a></li>
                                                    <li className="lvl-2"><a href="home13-auto-parts.html" className="site-nav lvl-2">Home 13 - Auto Parts</a></li>
                                                    <li className="lvl-2"><a href="home14-bags.html" className="site-nav lvl-2">Home 14 - Bags <span className="lbl nm_label1">New</span></a></li>
                                                </ul>
                                            </li>
                                            <li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">New Sections</a>
                                                <ul className="subLinks">
                                                    <li className="lvl-2"><a href="home11-grid.html" className="site-nav lvl-2">Image Gallery</a></li>
                                                    <li className="lvl-2"><a href="home5-cosmetic.html" className="site-nav lvl-2">Featured Product</a></li>
                                                    <li className="lvl-2"><a href="home7-shoes.html" className="site-nav lvl-2">Columns with Items</a></li>
                                                    <li className="lvl-2"><a href="home6-modern.html" className="site-nav lvl-2">Text columns with images</a></li>
                                                    <li className="lvl-2"><a href="home2-default.html" className="site-nav lvl-2">Products Carousel</a></li>
                                                    <li className="lvl-2"><a href="home9-parallax.html" className="site-nav lvl-2">Parallax Banner</a></li>
                                                </ul>
                                            </li>
                                            <li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">New Features</a>
                                                <ul className="subLinks">
                                                    <li className="lvl-2"><a href="home13-auto-parts.html" className="site-nav lvl-2">Top Information Bar <span className="lbl nm_label1">New</span></a></li>
                                                    <li className="lvl-2"><a href="#" className="site-nav lvl-2">Age Varification <span className="lbl nm_label1">New</span></a></li>
                                                    ...
                                                    <li className="lvl-2"><a href="#" className="site-nav lvl-2">Show Total Savings <span className="lbl nm_label3">Hot</span></a></li>
                            ...
                            <div className="megamenu style4">
                                <ul className="grid grid--uniform mmWrapper">
                                    ...
                                    <li className="grid__item lvl-1 col-md-6 col-lg-6">
                                        <a href="#"><img src={MegaMenuImg} alt="" title="" /></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    <li className="lvl1 parent megamenu"><a href="#">Product <i className="anm anm-angle-down-l"></i></a>
                        <div className="megamenu style2">
                            <ul className="grid mmWrapper">
                                ...
                                <li className="grid__item large-up--one-whole imageCol"><a href="#"><img src={MegaMenuImg2} alt="" /></a></li>
                            </ul>
                        </div>
                    </li>
