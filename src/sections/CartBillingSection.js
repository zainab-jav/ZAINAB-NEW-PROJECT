...
import paymentImg from "../images/payment-img.jpg"
                    ...
                    <div className="row">
                    	<div className="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
                            ...
                            <form action="#" method="post">
                                ...
                                <div className="actionRow">
                                    <div><input type="button" className="btn btn-secondary btn--small" value="Apply Coupon" /></div>
                                </div>
                            </form>
                        </div>
                        <div className="col-12 col-sm-12 col-md-4 col-lg-4 mb-4">
							...
							<form action="#" method="post">
                                ...
                                <div className="actionRow">
                                    <div><input type="button" className="btn btn-secondary btn--small" value="Calculate shipping" /></div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div className="col-12 col-sm-12 col-md-4 col-lg-4 cart__footer">
                            <div className="solid-border">	
                              ...
                              <div className="row border-bottom pb-2 pt-2">
                                <span className="col-12 col-sm-6 cart__subtotal-title"><strong>Grand Total</strong></span>
                              ...
                              <p className="cart_tearm">
                                <label>
                                  <input type="checkbox" name="tearm" className="checkbox" value="tearm" required="" />
                                  I agree with the terms and conditions
								</label>
                              </p>
                              <input type="submit" name="checkout" id="cartCheckout" className="btn btn--small-wide checkout" value="Proceed To Checkout" disabled="disabled" />
                              <div className="paymnet-img"><img src={paymentImg} alt="Payment" /></div>
                              <p><Link to="#;">Checkout with Multiple Addresses</Link></p>
                            </div>
